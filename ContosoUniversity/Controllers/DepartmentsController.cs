...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DepartmentID,Name,Budget,StarteDate,RowVersion,InstructorID,StartDate")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartmentID,Name,Budget,StarteDate,RowVersion,InstructorID,StartDate")] Department department)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!DepartmentExits(department.DepartmentID))
                    {
                        return NotFound();
                    }
                    else
        ...
        public async Task<IActionResult> Delete(Department department)
        {
            ...
            private bool DepartmentExits(int id)
            {
